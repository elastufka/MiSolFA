...
def grid_eff_area(slit_input, substrate_input, distribution='uniform',instrument='MiSolFA'):
    ...
    eff_area = substrate_properties['substrate_area']*substrate_transmission_interp - slit_properties['percent_area']*slit_transmission_interp #area of substrate * transmission % + area of slits * transmission %? can this be greater than 1?
...
if __name__ == "__main__":
    data=grid_eff_area(['Au','200'],['C','200'],distribution='flare')
    #pprint.pprint(data)
