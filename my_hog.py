...
def hog(image, input_orientation=False, orientations=9, pixels_per_cell=(8, 8), cells_per_block=(3, 3),
    ...
    # EL change orientation binnings to be clustered around input_orientation - need to modify _hoghistogram.hog_histograms
